    ...
    <div class="event_view">
        ...
        <?php foreach($data as $row) { ?>
            <div class="new">
                ...
                <form action="<?php echo base_url(); ?>Main/event_edit_done" method="post" enctype="multipart/form-data">
                    <input type="hidden"  id="id"  name="id"  value="<?php echo $row->id; ?>">
                    <input type="hidden"  id="old"  name="old"  value="<?php echo $row->image; ?>">
                    <div class="row">
                        <div class="col">
                            <div id="profile" style="background-image: url('<?php echo base_url().'uploads/events/'.$row->image; ?>')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control" value="<?php echo $row->address; ?>" id="address" placeholder="Address of Event">
                            </div>
                        </div>
                    </div>
                    <div class="row">
